...
const fetchTickets = async () => {
    const response = await fetch(
        `https://dev.benevolo.de/api/ticket-service/bookings/${bookingId.value}`,
        {
            method: "GET",
            headers: {
...
//Rückerstattung der Tickets würde aber eigentlich durch Process Engine erfolgen
