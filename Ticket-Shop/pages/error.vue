<template>
  <div
    class="relative flex w-full items-start justify-center pt-10"
    v-if="error"
  >
    <div
    ...
    >
      <img class="w-24 h-24 mb-4" src="~/assets/image/error.png" alt="Error" />
      <h1
        class="text-2xl font-extrabold text-center text-black md:text-3xl lg:text-4xl mb-4"
      >
        Zahlung fehlgeschlagen
      </h1>
      <p class="text-center mt-2 text-gray-600">
        Leider ist ein Fehler bei der Verarbeitung Ihrer Zahlung aufgetreten.
        <br />
        Wir entschuldigen uns für die Unannehmlichkeiten. <br />
        Bitte versuchen Sie es in ein paar Minuten noch einmal oder wählen Sie
