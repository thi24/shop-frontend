    ...
    <form @submit.prevent="handleSubmit">
      <fieldset :class="{ dis: loading }" class="fields">
        <div class="nes-field">
          ...
          <input placeholder="Ihre e-Mail" type="email" name="email" id="email_field" class="nes-input" required />
        </div>
      ...
      <div class="">
        ...
        <div class="flex items-center">
          <button type="submit" @click="handleLoadingArrow"
          ...
          <div v-if="arrow && loading" class="ml-3">
            <svg aria-hidden="true" class="inline w-7 h-7 text-gray-200 animate-spin dark:text-gray-600 fill-blue-600"
